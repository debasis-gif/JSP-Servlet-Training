...
{
	public void service(HttpServletRequest req, HttpServletResponse res)  // the request and response objects are prepared by Tomcat 
																		  // No need to create/instantiate the objects 
	{
		 ...
		 * http://localhost:8081/Debasis-JspServlet/add?num1=10&num2=20 --> the function name add along with input parameters
