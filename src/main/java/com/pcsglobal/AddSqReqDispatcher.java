...
public class AddSqReqDispatcher extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
		...
		/*
		 * Now let's call another Servlet "SqServlet" from this servlet for the Square
		...
		req.setAttribute("sum", sum); // passing a "key", value pair
		
		RequestDispatcher rd = req.getRequestDispatcher("square");

		// mention the servlet url, this needs to go to web.xml to call the mapped
		// Servlet
		try {
			rd.forward(req, res);
			...
			// This method allows one servlet to do preliminary processing of a request and
